...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\POORAV\\OneDrive\\Desktop\\Lab in Psych\\Signal detection experiment\\Signal detection experiment_lastrun.py',
